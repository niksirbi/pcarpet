...
# ------------
#
# First, we'll load some data into fmri_pcarpet.
...
# ---------------
#
# With fmri_pcarpet, models are created with the :ref:Model class.
